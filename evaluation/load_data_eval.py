...
class NocsDataset(data.Dataset):
    def __init__(self, source=None, mode='test',
        ...
        if FLAGS.eval_refine_mug:
            self.detection_dir = '/media/hongzhidu/data/6DoF/Datasets/CAMERA/data/segmentation_results_refine_for_mug'
        else:
            self.detection_dir = '/media/hongzhidu/data/6DoF/Datasets/CAMERA/data/segmentation_results'
    ...
    def __getitem__(self, index):
        ...
        data_dict['cat_id_0_base'] = torch.as_tensor(obj_ids_0base, dtype=torch.long)
