...
def evaluate(argv):
    ...
    val_dataset = NocsDataset(source='CAMERA', mode='test')
    ...
    if os.path.exists(pred_result_save_path) :#and not FLAGS.save_nocs_map:
        ...
        resume_model_dict = torch.load('/media/hongzhidu/data/6DoF/LaPose/Mylapose/engine/output/modelsave/model_149.pth')
