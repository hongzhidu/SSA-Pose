...
def save_nocs_model_to_file(obj_model_dir):
    ...
    for subset in ['train', 'val']:
        ...
        for synsetId in ['02876657', '02880940', '02942699', '02946921', '03642806', '03797390']:
            ...
            for instance in inst_list:
                ...
                model_points = sample_points_from_mesh(path_to_mesh_model, 4096, fps=True, ratio=3)
        ...
        with open(os.path.join('/media/hongzhidu/data/6DoF/Datasets/mydata/obj_models_4096', 'camera_{}.pkl'.format(subset)), 'wb') as f:
    ...
    for subset in ['real_train', 'real_test']:
        ...
        for inst_path in inst_list:
            ...
            model_points = sample_points_from_mesh(inst_path, 4096, fps=True, ratio=3)
            model_points /= scale
        ...
        with open(os.path.join('/media/hongzhidu/data/6DoF/Datasets/mydata/obj_models_4096', '{}.pkl'.format(subset)), 'wb') as f:
            cPickle.dump(real, f)
    # save mug_meta information for re-labeling
    with open(os.path.join('/media/hongzhidu/data/6DoF/Datasets/mydata/obj_models_4096', 'mug_meta.pkl'), 'wb') as f:
...
if __name__ == '__main__':
    obj_model_dir = '/media/hongzhidu/data/6DoF/Datasets/obj_models'
