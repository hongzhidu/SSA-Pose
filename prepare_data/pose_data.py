...
def annotate_real_train(data_dir):
    ...
    real_train = open('/media/hongzhidu/data/6DoF/Datasets/mydata/Real/real_train_list.txt').read().splitlines()
...
if __name__ == '__main__':
    data_dir = '/media/hongzhidu/data/6DoF/Datasets'
