...
def convnext_backbone():
    ...
    pretrained_cfg['file'] = '/media/hongzhidu/data/6DoF/LaPose/convnext_base_1k_224_ema.pth'
...
if __name__ == '__main__':
    ...
    # model = torch.load('/media/hongzhidu/data/6DoF/LaPose/convnext_base_1k_224_ema.pth')
    # model = timm.create_model("convnext_base").default_cfg
    # print(model)
