...
class ViTExtractor:
    ...
    def create_model(model_type: str) -> nn.Module:
        ...
        if 'v2' in model_type:
            # model = torch.hub.load('facebookresearch/dinov2', model_type, source='local')
            model = torch.hub.load(repo_or_dir="/home/hongzhidu/.cache/torch/hub/dinov2-main/", model="dinov2_vits14", source='local')
